...
pygame.display.set_caption('Crazy Hen!!')
...
def game_play():
    ...
    Hen_image=pygame.image.load(os.path.join(IMAGE_PATH, 'Hen.jpg'))
    ...
    for i in range(display_height + 100, 14, -10):
        setText("Crazy Hen!!", 140, (display_width / 2 - 340, i), (225, 10, 10), (255, 255, 255), "Algerian")
        pygame.time.wait(5)

    # Underlines
    pygame.draw.line(gameDisplay, (125, 20, 220), (display_width / 2 - 340, 165), (display_width / 2 + 500, 165))
    pygame.draw.line(gameDisplay, (25, 120, 220), (display_width / 2 - 340, 168), (display_width / 2 + 500, 168))
    pygame.draw.line(gameDisplay, (220, 20, 125), (display_width / 2 - 340, 170), (display_width / 2 + 500, 170))

    pygame.time.wait(1000)

    gameDisplay.blit(bomb_image, (display_width / 2 + 500, 30))

    

    start = display_height + 42
    end = 299
    value = 0
    ...
    if credit_clicked:
        ...
        setText("Developer(CSE1):", 100, (display_width / 2 - 240, display_height / 2 - 150), (0, 170, 0), None, "Forte")
        
        setText("Renuka Joshi(012)", 60, (display_width / 2 - 170, display_height / 2 - 20), (i, j, k), None, "Times New Roman")

        pygame.time.wait(1500)    

        setText("Aditi Gulati(021)", 60, (display_height / 2 + 90, display_height / 2 + 55), (k, j, i), None, "Times New Roman")

        pygame.time.wait(1500)

        setText("Divya(016)", 60, (display_height / 2 + 90, display_height / 2 + 120), (k, j, i), None, "Times New Roman")
    ...
    while credit_clicked:
        ...
        #setText("", 100, (display_width / 2 - 170, display_height / 2 - 20), (i, j, k), None, "Elephant")    

        #setText("", 100, (display_height / 2 + 90, display_height / 2 + 80), (k, j, i), None, "Elephant")
